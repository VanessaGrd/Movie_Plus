    ...
    <>
      ...
      <div className={styles.aboutbody}>
        ...
        <div className={styles.aboutContainer}>
          ...
          <p>
            We have created a user-friendly platform where you can explore a
            huge collection of captivating movie posters. Whether you are an
            avid movie buff or simply looking for a enjoyable movie night,
            Movie+ is there for you.
            <br></br> <br></br>
            When you browse our site, you will discover several movie posters
            from of the most popular and varied genres.
            <br></br> <br></br>
